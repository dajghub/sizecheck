...
- **Assets store** (`extension/store-assets/`) : `promo-small` (440×280), `promo-large` (1400×560), `screenshot-store-1-widget` + `screenshot-store-2-pied-cm` (1280×800), `store-listing.md`, zip v1.1.0.
